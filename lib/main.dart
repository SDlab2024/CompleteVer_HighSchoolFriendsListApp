...
class _FriendListPageState extends State<FriendListPage> {
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                _buildTextField('趣味', (value) => hobby = value,
                    initialValue: hobby),
                _buildTextField('インスタID', (value) => instaId = value,
                    initialValue: instaId),
                _buildTextField('出会った場所', (value) => meetPlace = value,
                    initialValue: meetPlace),
              ],
            ),
          ),
          actions: <Widget>[
  ...
  void _loadFriends() async {
    ...
    if (friendList != null) {
      setState(() {
        friends = friendList
            .map((item) => Friend.fromJson(json.decode(item)))
            .toList();
        friends.sort((a, b) {
          if (a.isPinned && !b.isPinned) {
            return -1;
          ...
          return ListTile(
            ...
            trailing: Wrap(
              ...
              children: <Widget>[
                IconButton(
                  icon: Icon(
                    friends[index].isPinned
                        ? Icons.push_pin
                        : Icons.push_pin_outlined,
                    color:
                        friends[index].isPinned ? Colors.lightBlue[900] : null,
                  ),
